...
function _99.setup(opts)
  ...
  vim.api.nvim_create_user_command("NNNextRequestLogs", function()
    _99.next_request_logs()
  end, { desc = "Request logs: Next" })

  vim.api.nvim_create_user_command("NNPrevRequestLogs", function()
    _99.prev_request_logs()
  end, { desc = "Request logs: Previous" })
